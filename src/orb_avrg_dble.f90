...
!We will assume that exists a file StatisticalAverage.dat and StatisticalError.dat
!If that is not the case, you should run the Statistical Averager before
...
type orbit
   ...
   real*8,allocatable,dimension(:) :: observable,error
end type
real*8 :: aux
...
do o=1,numOrbits
   do t=1,nt
      write(10,'(4(I19.19,3X),2(ES23.15E3,3X))') orbits(o)%p2,orbits(o)%p4,orbits(o)%p6,t-1,orbits(o)%observable(t), orbits(o)%error(t)
   end do
end do
close(10)
